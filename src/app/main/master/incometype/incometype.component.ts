...
@Component({
  selector: 'app-incometype',
  templateUrl: './incometype.component.html',
  styleUrls: ['./incometype.component.scss']
})
export class IncometypeComponent {
  ...
  expensehead:any;
   ...
   public form = new FormGroup({
    ...
    incomeTypeName: new FormControl('', Validators.required),
 ...
 // =============================================================================
   ...
   onSubmit() {
     ...
     this.http.post(environment.SaveIncomeType, this.form.value).subscribe((result: any) => {
   ...
   onEdit(pId:any)
   {
     this.expensehead = this.datalist.filter(((x: { incomeTypeId: any; }) => x.incomeTypeId == pId));
     this.form.patchValue({
      incomeTypeId: this.expensehead[0].incomeTypeId,
      incomeTypeName:  this.expensehead[0].incomeTypeName,
