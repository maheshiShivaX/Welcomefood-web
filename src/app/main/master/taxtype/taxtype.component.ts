...
export class TaxtypeComponent {
  ...
  expensehead:any;
   ...
   public form = new FormGroup({
    ...
    taxTypeName: new FormControl('', Validators.required),
 ...
 // =============================================================================
   ...
   onSubmit() {
     ...
     this.http.post(environment.SaveTaxType, this.form.value).subscribe((result: any) => {
   ...
   onEdit(pId:any)
   {
     this.expensehead = this.datalist.filter(((x: { taxTypeId: any; }) => x.taxTypeId == pId));
     this.form.patchValue({
      taxTypeId: this.expensehead[0].taxTypeId,
      taxTypeName:  this.expensehead[0].taxTypeName,
