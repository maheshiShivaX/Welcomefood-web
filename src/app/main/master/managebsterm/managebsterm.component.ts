...
@Component({
  selector: 'app-managebsterm',
  templateUrl: './managebsterm.component.html',
  styleUrls: ['./managebsterm.component.scss']
})
export class ManagebstermComponent {
 ...
 // =============================================================================
   ...
   onSubmit() {
     ...
     this.http.post(environment.SaveBalanceSheetTerm, this.form.value).subscribe((result: any) => {
   ...
   onEdit(pId:any)
   {
     this.expensehead = this.datalist.filter(((x: { termsId: any; }) => x.termsId == pId));
     this.form.patchValue({
      termsId: this.expensehead[0].termsId,
      termsName:  this.expensehead[0].termsName,
      termsType:  this.expensehead[0].termsType,
